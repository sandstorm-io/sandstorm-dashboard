    ...
    settings: [
      {
        ...
        type: "text"
        description: "The name of the data source to use. Must be twitter|mailchimp|google|github|sandstorm|log|demoSandstorm|preorders|oasisMonitorData|sandstormUserData"
